...
| 変更履歴 | 1.0: 初版作成 / 1.1: §5.2 リポジトリ・ディレクトリ構成を追加 / 1.2: §7.2・§12 に TBR-002（本文上限・NUL 禁止）を反映 |
...
**解消済み（参照のみ）**: TBR-002（本文最大 12,000 文字、NUL 禁止）は [SRS §5.4](./requirements.md) に反映済み。§7.2 に要約を記載する。
