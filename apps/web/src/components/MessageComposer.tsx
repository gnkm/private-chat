...
export function MessageComposer({
	...
	return (
		<div className="border-t border-stone-200 bg-white p-4 dark:border-stone-700 dark:bg-stone-800/80">
			<div className="flex items-end gap-2">
				<textarea
					className="min-h-24 min-w-0 flex-1 resize-y rounded border border-stone-300 bg-white px-3 py-2 text-sm text-stone-900 dark:border-stone-600 dark:bg-stone-800 dark:text-stone-300"
				...
				<button
					type="button"
					className="shrink-0 rounded bg-stone-800 px-4 py-2 text-sm font-medium text-white hover:bg-stone-700 disabled:cursor-not-allowed disabled:bg-stone-300 disabled:text-stone-500 dark:bg-stone-600 dark:text-stone-100 dark:hover:bg-stone-500 dark:disabled:bg-stone-700 dark:disabled:text-stone-500"
					disabled={!canSend}
					onClick={onSend}
				>
					送信
